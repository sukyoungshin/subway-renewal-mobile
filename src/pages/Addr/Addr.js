...
import { FormStyled, FieldsetStyled, MapWrapperStyled, AddressInputStyled, CTAButtonStyled, ResultInputStyled, MapViewerStyled } from './Addr.style';
...
const Addr = () => {
  ...
  return (
    <main>
      <FormStyled onSubmit={HandleOrderStart} >
        {/* 배송지 및 주소검색 input */}
        <FieldsetStyled>
        ...
        <FieldsetStyled style={{ flex: 1 }}>
          ...
          {/* 입력받은 주소값이 있으면 지도 보여주고, 없으면 글귀 보여줌 */}
          {
            ...
            ? (
              <MapWrapperStyled>
                <MapViewerStyled id="map"></MapViewerStyled>
            ...
            : (
              <MapWrapperStyled padding>
                {/* 높이값을 없애서 화면에서 없앰 */}
                <MapViewerStyled id="map" hidden></MapViewerStyled>
